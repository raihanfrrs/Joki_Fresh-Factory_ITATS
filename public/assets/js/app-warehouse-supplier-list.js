  ...
  if (dt_brand_table.length) {
    var dt_user = dt_brand_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Supplier</span>',
