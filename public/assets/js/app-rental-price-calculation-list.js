...
$(function () {
    ...
    var dt_user = dt_brand_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          targets: 5,
          render: function (data, type, full, meta) {
            return full.price_rate;
          }
        },
        {
          targets: 6,
          render: function (data, type, full, meta) {
            return full.total_price;
          }
        },
        {
          targets: -1,
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Rental Price Calculation</span>',
          className: 'add-new btn btn-primary',
          attr: {
            'id': 'button-add-rental-price-calculation'
          }
        }
      ],
  ...
  // Delete Record
  $(document).on('click', '#button-delete-rental-price-calculation', function () {
    let id = $(this).attr('data-id');
    let formSelector = ".form-delete-rental-price-calculation-" + id;
