        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            {{-- <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
                    ...
                    <span class="badge bg-danger rounded-pill badge-notifications d-none"
                        id="label-total-account-deleted-count"></span>
                </a>
                ...
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        @if (auth()->user()->admin->getFirstMediaUrl('admin'))
                            <img src="{{ auth()->user()->admin->getFirstMediaUrl('admin') }}"
                                alt="{{ auth()->user()->admin->slug }}" class="h-auto rounded-circle">
                        @else
