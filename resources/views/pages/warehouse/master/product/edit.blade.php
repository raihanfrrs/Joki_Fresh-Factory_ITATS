          ...
          <div id="personal-details" class="content active dstepper-block fv-plugins-bootstrap5 fv-plugins-framework">
            <div class="row g-3">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="file" class="form-control" name="product_image_one" id="image1" onchange="previewImageProduct(1); fillUpProductImageUUID(1, '{{ !empty($mediaUuid[0]) ?? '' }}')">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="file" class="form-control" name="product_image_two" id="image2" onchange="previewImageProduct(2); fillUpProductImageUUID(2, '{{ !empty($mediaUuid[1]) ?? '' }}')">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="file" class="form-control" name="product_image_three" id="image3" onchange="previewImageProduct(3); fillUpProductImageUUID(3, '{{ !empty($mediaUuid[2]) }}')">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="file" class="form-control" name="product_image_four" id="image4" onchange="previewImageProduct(4); fillUpProductImageUUID(4, '{{ !empty($mediaUuid[3]) }}')">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="file" class="form-control" name="product_image_five" id="image5" onchange="previewImageProduct(5); fillUpProductImageUUID(5, '{{ !empty($mediaUuid[4]) }}')">
