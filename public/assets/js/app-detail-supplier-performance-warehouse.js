...
$(function () {
  ...
  var dt_brand_table = $('#listSupplierPerformanceReportTable');
  var suppler_id = dt_brand_table.attr('data-id');

  if (dt_brand_table.length) {
    var dt_user = dt_brand_table.DataTable({
      ajax: "/listSupplierPerformanceReportTable/"+ suppler_id,
      columns: [
        { data: '' },
        { data: 'index', class: 'text-center' },
        { data: 'supplier', class: 'text-center' },
        { data: 'product', class: 'text-center' },
        { data: 'arrival_date', class: 'text-center' },
